...
| #   | Item                                                                                            | What is needed                                                                                                                                                                                                                                                                                                                                                                               |
| --- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.1 | **`public/ads.txt` does not exist**, and `tests/export-shape.test.ts` asserts that it does not. | The AdSense publisher id, which the account shows as `pub-…` as soon as it exists, before review rather than on approval. Then the file lands and that expectation is inverted **in the same commit** — `docs/adsense.md` §3 puts it before the review request, because it is how the site is verified; §6 has the exact contents; §2 explains why a file without the id is worse than none. |
