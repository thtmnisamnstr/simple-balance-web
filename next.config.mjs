 ...
 * same build artifact is what Netlify publishes today and what an S3 bucket or
 ...
 * handlers, middleware, ISR, and the built-in image optimizer. A marketing
 ...
 * what authorizes the app's advertising inventory. See
...
const nextConfig = {
  ...
  images: {
    // The optimizer is a server. Without this, `next build` fails the moment
